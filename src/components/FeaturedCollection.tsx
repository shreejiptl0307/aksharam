  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-24 px-5 sm:px-8 lg:px-16 max-w-[1440px] mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-14 items-center">
        ...
        <div className="lg:col-span-5 flex flex-col justify-center space-y-3 sm:space-y-4 lg:pl-4 order-2">
          <ScrollReveal delay={120}>
            ...
            <p className="text-sm sm:text-base text-[#66635F] font-light leading-relaxed max-w-md mb-4 sm:mb-5">
              Statement pieces defined by detailed craftsmanship and contemporary silhouettes.
            </p>
            <div>
              <Link
                href="/collections/shisha-lehengas"
                className="group inline-flex items-center space-x-1.5 min-h-[44px] text-xs uppercase tracking-[0.15em] font-medium text-[#171717] hover:opacity-80 transition-opacity py-2"
              >
                <span>Explore</span>
